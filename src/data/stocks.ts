...
// Base prices reflect approximate EGX closing prices as of mid-2025.
// They are overwritten immediately at runtime by Yahoo Finance live data.
export const EGX_STOCKS: EGXStock[] = [
  ...
  { ticker: 'ORAS',  name: 'Orascom Construction',              nameAr: 'أوراسكوم للإنشاء والتشييد',     sector: 'Construction', basePrice: 95.00,  pe: 12.1, dividendYield: 3.2,  marketCapM: 44000,  volatility: 0.010 },
